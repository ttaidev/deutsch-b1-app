...
3. Abreise: Am Tag Ihrer Abreise ist das Zimmer bis spätestens 10:30 Uhr vollständig zu räumen und die Zimmerkarte abzugeben. Ein sogenannter "Late Check-out" (Verlängerung bis 15:00 Uhr) ist nur bei geringer Auslastung des Hotels und nach vorheriger Absprache mit dem Management möglich. Hierfür wird eine Pauschalgebühr in Höhe von 35 Euro fällig.`,
    questions: [
      { id: 1, question: "Was muss ein Gast tun, wenn er sein Frühstück mitnehmen möchte?", options: ["A) Er muss sich am Morgen direkt an das Küchenpersonal wenden.", "B) Er muss dies am Abend vorher bis 19:00 Uhr an der Rezeption anmelden.", "C) Er darf einfach etwas vom Buffet in eine Tüte packen."], correct: "B) Er muss dies am Abend vorher bis 19:00 Uhr an der Rezeption anmelden.", explanation: "Dies muss jedoch zwingend am Vorabend bis spätestens 19:00 Uhr an der Hauptrezeption angemeldet werden. (Tuy nhiên, điều này bắt buộc phải được đăng ký vào tối hôm trước tại quầy lễ tân chính, muộn nhất là 19:00 giờ.)" },
      { id: 2, question: "Welche Dienstleistung im Wellnessbereich kostet extra Geld?", options: ["A) Das Schwimmen im Hallenbad.", "B) Die Benutzung der Sauna.", "C) Spezielle Spa-Behandlungen wie Massagen."], correct: "C) Spezielle Spa-Behandlungen wie Massagen.", explanation: "Spezielle Spa-Behandlungen wie Massagen müssen jedoch separat gebucht und bezahlt werden. (Tuy nhiên, các phương pháp trị liệu spa đặc biệt như mát-xa phải được đặt riêng và trả phí.)" },
      { id: 3, question: "Wohin sollen die Gäste die nassen Handtücher bringen?", options: ["A) Sie sollen sie auf den Boden im Zimmer werfen.", "B) Sie sollen sie in weiße Körbe beim Wellnessbereich legen.", "C) Sie sollen sie dem Zimmermädchen persönlich geben."], correct: "B) Sie sollen sie in weiße Körbe beim Wellnessbereich legen.", explanation: "...sondern ausschließlich in die dafür vorgesehenen weißen Auffangkörbe am Ausgang des Wellnessbereichs. (...mà thay vào đó hãy chỉ bỏ vào các giỏ thu gom màu trắng được bố trí sẵn ở lối ra của khu vực chăm sóc sức khỏe.)" },
      { id: 4, question: "Unter welcher Bedingung kann man sein Zimmer am Abreisetag länger behalten?", options: ["A) Wenn man extra bezahlt und es vorher mit dem Management klärt.", "B) Wenn man krank ist und eine Bestätigung vom Arzt hat.", "C) Das ist in diesem Hotel grundsätzlich niemals erlaubt."], correct: "A) Wenn man extra bezahlt und es vorher mit dem Management klärt.", explanation: "Ein... 'Late Check-out'... ist nur... nach vorheriger Absprache... möglich. Hierfür wird eine Pauschalgebühr... fällig. (Dịch vụ 'Trả phòng trễ' chỉ khả thi khi có sự thỏa thuận trước... Đối với dịch vụ này, sẽ thu một khoản phí trọn gói...)" }
    ]
  },
  {
    id: "lesen-ru-2",
...
3. Sicherheit und Brandschutz: Aus brandschutzrechtlichen Gründen ist das Abstellen von Fahrrädern, E-Scootern oder Möbeln in den Fluren und im gesamten Treppenhaus strengstens verboten. Diese Fluchtwege müssen immer frei bleiben. Bitte nutzen Sie für Ihre Fahrräder den beleuchteten, überdachten Fahrradständer direkt vor dem Haupteingang. Das Halten von Haustieren (mit Ausnahme von kleinen Fischen in Aquarien) ist im gesamten Gebäude aus hygienischen Gründen untersagt.`,
    questions: [
      { id: 1, question: "Wann müssen die Studierenden im Wohnheim besonders leise sein?", options: ["A) Nur am Wochenende und in der Prüfungszeit.", "B) Täglich von 22 bis 7 Uhr und an Sonn- und Feiertagen den ganzen Tag.", "C) Jeden Tag von 22 bis 7 Uhr, außer am Samstag."], correct: "B) Täglich von 22 bis 7 Uhr und an Sonn- und Feiertagen den ganzen Tag.", explanation: "Die gesetzlichen Ruhezeiten zwischen 22:00 und 07:00 Uhr, sowie an Sonn- und Feiertagen ganztägig, sind... kompromisslos einzuhalten. (Thời gian nghỉ ngơi theo luật định từ 22:00 đến 07:00, cũng như cả ngày vào các ngày Chủ nhật và ngày lễ, phải được... tuân thủ tuyệt đối.)" },
      { id: 2, question: "Wer ist hauptsächlich für die Sauberkeit der Küchen zuständig?", options: ["A) Eine Reinigungsfirma putzt jeden Abend alles sauber.", "B) Die Studierenden müssen nach dem Kochen selbst putzen.", "C) Der Hausmeister kontrolliert und putzt die Küche."], correct: "B) Die Studierenden müssen nach dem Kochen selbst putzen.", explanation: "Jeder Bewohner ist verpflichtet, Herd, Spüle und Arbeitsflächen nach jeder Benutzung selbstständig und gründlich zu reinigen. (Mỗi cư dân có nghĩa vụ phải tự mình lau chùi cẩn thận bếp, bồn rửa và bề mặt làm việc sau mỗi lần sử dụng.)" },
      { id: 3, question: "Wo müssen die Fahrräder der Studenten geparkt werden?", options: ["A) In den Fluren vor den Zimmern.", "B) Vor dem Haupteingang in einem speziellen Fahrradständer.", "C) Im Treppenhaus, wenn es regnet."], correct: "B) Vor dem Haupteingang in einem speziellen Fahrradständer.", explanation: "Bitte nutzen Sie für Ihre Fahrräder den beleuchteten, überdachten Fahrradständer direkt vor dem Haupteingang. (Vui lòng để xe đạp của bạn ở giá để xe có mái che, được chiếu sáng ngay trước lối vào chính.)" },
      { id: 4, question: "Welche Haustiere sind in den Zimmern ausnahmsweise erlaubt?", options: ["A) Keine, alle Tiere sind absolut verboten.", "B) Nur kleine Hunde oder Katzen, die nicht bellen.", "C) Nur kleine Fische in einem Aquarium."], correct: "C) Nur kleine Fische in einem Aquarium.", explanation: "Das Halten von Haustieren (mit Ausnahme von kleinen Fischen in Aquarien) ist... untersagt. (Việc nuôi thú cưng (ngoại trừ nuôi cá nhỏ trong bể thủy sinh) là... bị cấm.)" }
    ]
  },
  {
    id: "lesen-ru-5",
